...
<section class="content">
  <div class="box">
    <div class="box-header with-border">
      <h4 class="box-title text-capitalize">Data background</h4>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="bg_footer_demografi" class="col-form-label"> Bg footer demografi: <span class="text-danger">*</span> </label>
                <textarea cols="40" rows="5" id="bg_footer_demografi" name="bg_footer_demografi" class="form-control" placeholder="Bg footer demografi" minlength="0" required></textarea>
              </div>
            </div>
          </div>
  ...
  function upload(idAlumni) {
    ...
    var initUppy2 = function() {
      ...
      uppyDashboard.use(XHR, {
        endpoint: '<?= base_url()  ?>/background/upload/' + idAlumni + '',
        responseType: 'text',
        formData: true,
        bundle: true,
    ...
    if (typeof id === 'undefined' || id < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $("#data-form #bg_footer_demografi").val(response.bg_footer_demografi);
