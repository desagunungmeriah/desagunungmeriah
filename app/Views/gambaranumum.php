...
<section class="content">
  <div class="box">
    <div class="box-header with-border">
      <h4 class="box-title text-capitalize">Data gambaran umum</h4>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="gambaran_umum" class="col-form-label"> Gambaran Umum: <span class="text-danger">*</span> </label>
                <textarea name="gambaran_umum" id="gambaran_umum" class="form-control" placeholder="gambaran_umum" minlength="0" required></textarea>
              </div>
            </div>
          </div>
    ...
    if (typeof id === 'undefined' || id < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $("#data-form #gambaran_umum").val(response.gambaran_umum);
