...
<section class="content">
  <div class="box">
    <div class="box-header with-border">
      <h4 class="box-title text-capitalize">Data slider</h4>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                ...
                <input type="text" id="judul" name="judul" class="form-control" placeholder="Judul" minlength="0" maxlength="200" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="slider_img" class="col-form-label"> Gambar Slider: <span class="text-danger">*</span> </label>
                <input type="text" id="slider_img" name="slider_img" class="form-control" value="default.png" readonly placeholder="Gambar Slider" minlength="0" maxlength="200" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="redirect" class="col-form-label"> Redirect: <span class="text-danger">*</span> </label>
                <input type="text" id="redirect" name="redirect" class="form-control" placeholder="Redirect" minlength="0" maxlength="200" required>
              </div>
            </div>
          </div>
...
<div id="upload-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md">
    <div class="modal-content">
      <div class="text-center bg-info p-3" id="model-header">
        <h4 class="modal-title text-white" id="info-header-modalLabel">Upload Foto Slide</h4>
      </div>
      <div class="modal-body">
  ...
  function upload(idAlumni) {
    ...
    var initUppy2 = function() {
      ...
      uppyDashboard.use(XHR, {
        endpoint: '<?= base_url()  ?>/slider/upload/' + idAlumni + '',
        responseType: 'text',
        formData: true,
        bundle: true,
    ...
    if (typeof id === 'undefined' || id < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $("#data-form #slider_img").val(response.slider_img);
          $("#data-form #redirect").val(response.redirect);
