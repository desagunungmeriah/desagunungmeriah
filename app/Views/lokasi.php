...
<section class="content">
  <div class="box">
    <div class="box-header with-border">
      <h4 class="box-title text-capitalize">Data lokasi</h4>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="maps_lokasi" class="col-form-label"> Maps lokasi: <span class="text-danger">*</span> </label>
                <textarea cols="40" rows="5" id="maps_lokasi" name="maps_lokasi" class="form-control" placeholder="Maps lokasi" minlength="0" required></textarea>
              </div>
            </div>
          </div>
    ...
    if (typeof id === 'undefined' || id < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $("#data-form #maps_lokasi").val(response.maps_lokasi);
