...
<section class="content">
  <div class="box">
    <div class="box-header with-border">
      <h4 class="box-title text-capitalize">Data jenis kegiatan</h4>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="jenis_kegiatan" class="col-form-label"> Jenis kegiatan: <span class="text-danger">*</span> </label>
                <input type="text" id="jenis_kegiatan" name="jenis_kegiatan" class="form-control" placeholder="Jenis kegiatan" minlength="0" required>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="keterangan" class="col-form-label"> Keterangan: </label>
                <textarea cols="40" rows="5" id="keterangan" name="keterangan" class="form-control" placeholder="Keterangan" minlength="0"></textarea>
              </div>
            </div>
          </div>
...
<div id="upload-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md">
    <div class="modal-content">
      <div class="text-center bg-info p-3" id="model-header">
        <h4 class="modal-title text-white" id="info-header-modalLabel">Upload Foto Kegiatan</h4>
      </div>
      <div class="modal-body">
    ...
    var KTUppy = function() {
      ...
      var initUppy2 = function() {
        ...
        uppyDashboard.use(XHR, {
          endpoint: '<?= base_url()  ?>/fotokegiatan/upload/' + idAlumni + '',
          responseType: 'text',
          formData: true,
          bundle: true,
    ...
    if (typeof id === 'undefined' || id < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $("#data-form #jenis_kegiatan").val(response.jenis_kegiatan);
