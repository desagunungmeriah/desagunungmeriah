...
<section class="content">
  <div class="box">
    <div class="box-header with-border">
      <h4 class="box-title text-capitalize">Data misi</h4>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                <label for="misi" class="col-form-label"> Misi: <span class="text-danger">*</span> </label>
                <textarea name="misi" id="misi" class="form-control" placeholder="misi" minlength="0" required></textarea>
              </div>
            </div>
          </div>
    ...
    if (typeof id === 'undefined' || id < 1) { //add
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $("#data-form #misi").val(response.misi);
